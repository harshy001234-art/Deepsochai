              ...
              {[
                {
                  ...
                  title: "Book a Demo",
                  sub: "See DeepSoch AI in action.",
                  href: "mailto:contact@deepsoch.ai?subject=Book%20a%20Demo",
                },
                {
                  icon: <Building2 className="w-4 h-4 text-blue-600" />,
                  title: "Enterprise & Sales",
                  sub: "Custom compute for your team.",
                  href: "mailto:contact@deepsoch.ai?subject=Enterprise%20%2F%20Sales%20Inquiry",
                },
                {
                  icon: <Headphones className="w-4 h-4 text-blue-600" />,
                  title: "Support",
                  sub: "Technical help and billing.",
                  href: "mailto:contact@deepsoch.ai?subject=Support%20Request",
                },
              ].map((card) => (
                <a
                  key={card.title}
